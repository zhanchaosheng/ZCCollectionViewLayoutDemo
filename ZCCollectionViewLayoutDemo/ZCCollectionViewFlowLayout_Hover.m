//
//  ZCCollectionViewFlowLayout_Hover.m
...
@implementation ZCCollectionViewFlowLayout_Hover
...
{
    if (self.hoverTopCell) {
        return [self handleHoverForTopCell:rect];
    }
    else {
        return [self handleHoverSectionHeader:rect];
    }
}
...
#pragma mark - section header悬停

- (NSArray *)handleHoverSectionHeader:(CGRect)rect {
...
#pragma mark - 顶部cell悬停

- (NSArray *)handleHoverForTopCell:(CGRect)rect {
    //拿到当前可见区域内的布局属性
